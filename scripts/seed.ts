...
async function main() {
  ...
  // Create admin user
  const adminEmail = process.env.ADMIN_EMAIL || "admin@praxis-amara.de";
...
Your Praxis Amara Team`;
  ...
  if (newsCount === 0) {
    await prisma.newsPost.createMany({
      data: [
        {
          titleDe: "Willkommen auf unserer neuen Website",
          titleEn: "Welcome to our new website",
          contentDe: websiteContentDe,
          contentEn: websiteContentEn,
          slug: "willkommen-neue-website",
          published: true,
          publishedAt: new Date(),
        },
        {
          titleDe: "Neue Ultraschallgeräte in unserer Praxis",
          titleEn: "New ultrasound equipment in our practice",
          contentDe: ultrasoundContentDe,
          contentEn: ultrasoundContentEn,
          slug: "neue-ultraschallgeraete",
          published: true,
          publishedAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), // 1 week ago
        },
        {
          titleDe: "Unser Team wächst: Willkommen Frau Khakan Amara",
          titleEn: "Our team is growing: Welcome Ms. Khakan Amara",
          contentDe: teamContentDe,
          contentEn: teamContentEn,
          slug: "team-erweiterung-khakan-amara",
          published: true,
    ...
    console.log("News posts already exist");
  }
